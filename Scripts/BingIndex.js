...
function createPins() {
    var pin = new Microsoft.Maps.Pushpin(33, -70, { text: 'Estacion Hidraulica' });
    map.entities.push(pin);

    pin = new Microsoft.Maps.Pushpin(33.5, -70.5, { text: 'Estacion Meteorologica' });
    map.entities.push(pin);

    pin = new Microsoft.Maps.Pushpin(polyPoints[0].latitude, polyPoints[0].longitude, { text: 'Estacion Hidraulica Meteorologica' });
    map.entities.push(pin);
}
